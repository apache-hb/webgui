...
namespace {
    ...
    static WNDCLASSEXW                  g_wndClass = {};
    static HWND                         g_hWnd = nullptr;
    static bool                         g_ShouldClose = false;
    static std::array<float, 4>         gClearColour = {0.45f, 0.55f, 0.60f, 1.00f};
...
int Platform_Windows::setup(const PlatformCreateInfo& createInfo) {
    ...
    std::wstring wtitle = widen(createInfo.title);

    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"GuiWindowCls", nullptr };
    ::RegisterClassExW(&wc);
    g_hWnd = ::CreateWindowW(wc.lpszClassName, wtitle.c_str(), WS_OVERLAPPEDWINDOW, 100, 100, (int)(1280 * scale), (int)(800 * scale), nullptr, nullptr, wc.hInstance, nullptr);
...
void Platform_Windows::end() {
    ...
    const float clear_color_with_alpha[4] = { gClearColour[0] * gClearColour[3], gClearColour[1] * gClearColour[3], gClearColour[2] * gClearColour[3], gClearColour[3] };
